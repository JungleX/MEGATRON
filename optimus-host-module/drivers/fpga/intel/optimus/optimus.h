...
#ifdef SOFTWARE_VTP
    struct task_struct *vtp;
    //struct hlist_head hash_pt[8192];
    DECLARE_HASHTABLE(hash_pt, 13);
    vtp_pt *pt;
    u8 *vtp_buffer;
    struct mutex pt_lock;
#endif 
